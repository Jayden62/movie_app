...
import 'package:movie/screens/detail/DetaiScreen.dart';
                          ...
                          for (int index = 0;
                            ...
                            items[index] = MovieItem(
                              ...
                              onTapItem: () {
                                ...
                                /// movie detail, get scaffoldkey from HomeScreen(). it means that MovieScreen() is contained by HomeScreen().
                                /// when i want to navigate new screen i have to use scaffoldkey from HomeScreen().
